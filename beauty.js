...
var Filter=document.querySelector("#filterOpt");
Filter.addEventListener("change",function(){
    let filtered=productArr.filter((el)=>{
        if(Filter.value=="All"){
            return Filter.value=="All";
        }
        return Filter.value== el.category;
    })
    console.log(filtered);
    console.log(displayPro(filtered));
})
function displayPro(parr){
    let Arr=parr;
